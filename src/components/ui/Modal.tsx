...
export function Modal({
  ...
  return createPortal(
    ...
    >
      <div
        className="border-subtle bg-surface-raised max-h-[90vh] w-full max-w-[480px] overflow-y-auto rounded-t-[18px] border p-[22px] shadow-[0_30px_70px_-20px_rgba(0,0,0,0.6)] sm:rounded-[18px]"
